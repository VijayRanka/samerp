    ...
    <div class="quick-actions_homepage">
      ...
      <!-- loop for all of them goes here -->
       <!--  <li class="bg_ls"> <a href="#"> <i class="icon-user"></i><span class="label label-success"></span>Supply & Sale</a> </li>
    	...
    	<li class="bg_lr"> <a href="/SAMERP/jsp/admin/payment/driverPayment.jsp" style="width: 104px;"> <i class="icon-money"></i><span class="label label-success"></span>Driver Payment</a> </li>
      </ul>
    </div>
<!--End-Action boxes-->    
 </div>
